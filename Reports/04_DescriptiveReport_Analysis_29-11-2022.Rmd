---
title: "04_DescriptiveReport_Analysis_29-11-2022"
author: "Mehak Khanna"
date: "`r Sys.Date()`"
...
library(eeptools)
library(knitr)
scc_doi<-read_csv(here("Data","clean_scc_doi_29-11-2022.csv"))

baseline_scc_doi<- read_csv(here("Data","clean_baseline_scc_doi_29-11-2022.csv"))
...
#Demographic-------------------
Tab3<-CreateTableOne(vars = c("age", "GenderSexe", "tobacco_hist", "tobacco_stat_diag", "alc_hist", "alc_stat_diag"),
...
tab17<-CreateTableOne(vars = c("age","GenderSexe", "tobacco_hist", "tobacco_stat_diag", "alc_hist", "alc_stat_diag","t_clinc_stage","n_clinc_stage", "t_patho_stage","n_patho_stage","surgery_type","Num_positive_nodes_fac","Pathological.stage.overall....Stage.Pathologique.Global","Was.there.Radiotherapy...Une.Radiotherapie.a.t.elle.administree..","Was.there.Chemotherapy...Une.Chimiotherapie.a.t.elle.administree.."),
                      factorVars = c("GenderSexe", "tobacco_hist", "tobacco_stat_diag", "alc_hist", "alc_stat_diag","t_clinc_stage","n_clinc_stage", "t_patho_stage","n_patho_stage","surgery_type","Num_positive_nodes_fac","Pathological.stage.overall....Stage.Pathologique.Global","Was.there.Radiotherapy...Une.Radiotherapie.a.t.elle.administree..","Was.there.Chemotherapy...Une.Chimiotherapie.a.t.elle.administree.."),
                      strata = "reason_death.y",
                      data = baseline_scc_doi%>% filter(expired == "Expired"),
                      includeNA = T, test = F)%>% print(showAllLevels=T)
...
```{r, echo=FALSE}
tab18<-CreateTableOne(vars = c("age","GenderSexe", "tobacco_hist", "tobacco_stat_diag", "alc_hist", "alc_stat_diag","t_clinc_stage","n_clinc_stage", "t_patho_stage","n_patho_stage","surgery_type","Num_positive_nodes_fac","Pathological.stage.overall....Stage.Pathologique.Global","Was.there.Radiotherapy...Une.Radiotherapie.a.t.elle.administree..","Was.there.Chemotherapy...Une.Chimiotherapie.a.t.elle.administree.."),
                      factorVars = c("GenderSexe", "tobacco_hist", "tobacco_stat_diag", "alc_hist", "alc_stat_diag","t_clinc_stage","n_clinc_stage", "t_patho_stage","n_patho_stage","surgery_type","Num_positive_nodes_fac","Pathological.stage.overall....Stage.Pathologique.Global","Was.there.Radiotherapy...Une.Radiotherapie.a.t.elle.administree..","Was.there.Chemotherapy...Une.Chimiotherapie.a.t.elle.administree.."),
                      strata = "metastasis",
                      data = baseline_scc_doi%>% filter(recurrence == "recurrence"),
                      includeNA = T, test = F)%>% print(showAllLevels=T)
kableone(tab18, caption= "18: Distribution of participant  for those who had recurrence by metastasis")
```

```{r, echo=FALSE}
baseline_scc_doi$doi_125_round<- round(baseline_scc_doi$doi_125)
tab19<-CreateTableOne(vars = "doi_125_round",
               factorVars = "doi_125_round",
               strata = c("surgery_type","metastasis"),
               data = baseline_scc_doi,
               includeNA = T,
               test = F)%>% print(showAllLevels=T)
kableone(tab19, caption= "19: Distribution of participant by type of surgery and metastasis")

tab20<-CreateTableOne(vars = "doi_125_round",
               factorVars = "doi_125_round",
               strata = c("surgery_type","reason_death.y"),
               data = baseline_scc_doi,
               includeNA = T,
               test = F)%>% print(showAllLevels=T)
kableone(tab20, caption= "20: Distribution of participant by type of surgery and reason of death")

tab21<-CreateTableOne(vars = "doi_125_round",
               factorVars = "doi_125_round",
               strata = c("surgery_type","recurrence"),
               data = baseline_scc_doi,
               includeNA = T,
               test = F)%>% print(showAllLevels=T)
kableone(tab21, caption= "21: Distribution of participant by type of surgery and recurrence")

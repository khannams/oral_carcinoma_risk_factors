---
title: "03_DescriptiveReport_26-11-2022"
author: "Mehak Khanna"
date: "`r Sys.Date()`"
...
tab17<-CreateCatTable(vars = c("GenderSexe", "tobacco_hist", "tobacco_stat_diag", "alc_hist, alc_stat_diag","t_clinc_stage","n_clinc_stage", "t_patho_stage","n_patho_stage", "Pathological.stage.overall....Stage.Pathologique.Global","surgery_type","Num_positive_nodes_fac","Pathological.stage.overall....Stage.Pathologique.Global","Was.there.Chemotherapy...Une.Chimiotherapie.a.t.elle.administree.."),
                      strata = "reason_death",
                      data = (scc_doi%>%filter(...148 == "Expired")),
                      includeNA = T, test = F)%>% print(showAllLevels=T)
